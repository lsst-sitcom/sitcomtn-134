...
\setDocAbstract{%
This note gives an overview of a jupyter notebook that performs raytracing through the CBP and LSST and computes ghosting and transmission profiles. The notebook is available at \url{https://github.com/lsst-ts/cbp\_analysis/tree/b7cd1ce2b2fbd5c0c0ffdd08eabdfc9405884951/Pointing\%20\%26\%20ghosting\%20modeling\%20notebook}
