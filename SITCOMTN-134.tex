...
\setDocAbstract{%
This note gives an overview of a jupyter notebook that performs raytracing through the CBP and LSST and computes ghosting and transmission profiles. The notebook has three main uses:
